...
export const ListStory = () => {
  const { story, editStory, deleteStory} = useContext(GlobalContext);
  // console.log(article);
  return (
    <Fragment>
                        ...
                        <div className="listBox">
                          <div className="row">
                            ...
                            <div className="col-md-4 actionIcons text-right">
                              ...
                              <div className="roundIconDelete">
                                <button className="noBg" onClick={() => deleteStory(story.id)} >
                                <svg
                                  width="24"
                                  height="24"
                                  viewBox="0 0 24 24"
